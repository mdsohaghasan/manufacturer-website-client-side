...
import sum from "../../../images/summery/summ.png";

const Summary = () => {
    return (
        <div class="hero min-h-screen bg-base-200 ">
            <div class="hero-content flex-col lg:flex-row mx-24 mx-auto">
                <img src={sum} class="max-w-sm rounded-lg shadow-2xl" />
                <div>
                    <h1 class="text-5xl font-bold">Fix Phone</h1>
